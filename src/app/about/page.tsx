      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-[1fr_380px]">
        ...
        <div>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <a href="https://tryhackme.com/p/asmitdesai" target="_blank" rel="noopener noreferrer" className="rounded border border-[#22c55e]/30 px-4 py-2 font-[family-name:var(--font-mono)] text-sm text-[#22c55e] transition-all hover:border-[#22c55e] hover:bg-[#22c55e]/5">TryHackMe ↗</a>
          </div>
        </div>
